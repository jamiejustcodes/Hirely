            ...
            return (
              <button
                ...
                className={`text-left p-6 rounded-2xl border transition-all duration-300 relative overflow-hidden flex flex-col justify-between space-y-4 shadow-xs ${
                  isActive
                    ? "bg-white border-zinc-300 shadow-md ring-1 ring-sky-500/20"
              ...
              >
                ...
                <div className="space-y-2 pt-2">
                  <span className="text-xs font-sans font-semibold text-sky-600 tracking-wide">
                    {step.badge}
                  </span>
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="lg:col-span-6 p-6 rounded-2xl bg-white border border-zinc-200/90 space-y-4 font-sans text-xs shadow-xs">
                  <div className="flex items-center justify-between pb-3 border-b border-zinc-200/70">
                    <div>
                      <span className="text-xs font-semibold text-zinc-900 block">Keyword Extraction Matrix</span>
                      <span className="text-[11px] text-zinc-500 font-normal">Live analysis against role parameters</span>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="p-3 rounded-xl bg-zinc-50/70 border border-zinc-200/80 flex items-center justify-between shadow-2xs hover:border-zinc-300 transition-colors">
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-zinc-800 font-medium text-xs">TypeScript & Next.js</span>
                      </div>
            ...
            {activeStep === 2 && (
              ...
              >
                ...
                <div className="lg:col-span-6 flex justify-center p-6 rounded-2xl bg-white border border-zinc-200/90 shadow-xs">
